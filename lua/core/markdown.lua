...
M.CreateCodeBoookBorder = function (MaxLine,Begin,End)
  ...
  vim.api.nvim_buf_set_extmark(0,M.namespace_id,Begin-1,0,{ virt_text_pos = 'overlay', virt_text = {{ str, {"Title_1"}}}})
  vim.api.nvim_buf_set_extmark(0,M.namespace_id,End-1,0,{ virt_text_pos = 'overlay', virt_text = {{ str, {"Title_1"}}}})
end
