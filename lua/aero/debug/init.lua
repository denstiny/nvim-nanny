...
--- Dap 调试配置
--- cpp,c,rust
require('aero.debug.conf.cpp').setup(DapInstall,dap)
dap.configurations.c = dap.configurations.cpp
dap.configurations.rust = dap.configurations.cpp
--- python
require('aero.debug.conf.python').setup(dapInstallPath,dap)
--- go
require('aero.debug.conf.go').setup(dap)
--- 配置Dap Ui
dapui.setup({
...
vim.fn.sign_define('DapBreakpoint',          { text='●', texthl='DapUIBreakpointsCurrentLine', linehl='debugBreakpoint', numhl='debugBreakpoint' })
