...
-- @file        : vir-text
-- @created     : 星期六 10月 01, 2022 00:16:53 CST @github      : https://github.com/denstiny
...
M.NoFileType = { 'startify', 'NvimTree', 'Trouble', 'Outline', 'norg', 'packer', 'lsp-installer', 'toggleterm', 'packer',
  'TelescopePrompt', 'CompetiTest', 'help', 'startuptime', 'markdown' }
vim.cmd [[
