...
function M.attach(bufnr)
	local cfg = {
		...
		floating_window_off_x = function(info)
			...
			return the_absolute_position_i_want - cur_pos + 100
		end, -- adjust float windows x position.
		-- can be either a number or function
		floating_window_off_y = -100, -- adjust float windows y position. e.g -2 move window up 2 lines; 2 move down 2 lines
